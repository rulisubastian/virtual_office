    ...
    <main class="main" id="top">
      <div class="content">
        <nav class="navbar navbar-expand-md fixed-top" id="navbar" data-navbar-soft-on-scroll="data-navbar-soft-on-scroll">
          <div class="container-fluid px-0 header-menu-margin">
            <a href="/"><img class="navbar-brand w-75" src="{{ asset('assets/img/logos/logo.png') }}" alt="logo" /></a>
            <a class="navbar-brand fw-bold d-none d-md-block" href="/"></a>
            @php
            
            @endphp
            @if(!empty(session('user')))
              <a class="btn btn-secondary btn-sm ms-md-x1 mt-lg-0 order-md-1 ms-auto" href="{{ route('logout') }}">Logout </a>
            @else
              <a class="btn btn-primary btn-sm ms-md-x1 mt-lg-0 order-md-1 ms-auto" href="{{ route('login') }}">Sign In </a>
              <a class="btn btn-success btn-sm ms-md-x1 mt-lg-0 order-md-1 ms-auto" href="{{ route('signup') }}">Sign Up </a>
            @endif
            ...
            <div class="collapse navbar-collapse justify-content-md-end" id="navbar-content" data-navbar-collapse="data-navbar-collapse">
              <ul class="navbar-nav gap-md-2 gap-lg-3 pt-x1 pb-1 pt-md-0 pb-md-0" data-navbar-nav="data-navbar-nav">
                ...
                <li class="nav-item"> <a class="nav-link lh-xl" href="{{ route('listing') }}">Listing</a></li>
              </ul>
            </div>
          </div>
        </nav>
              ...
              <div class="container">
                <div class="row gy-4 gy-md-8 pt-9 pt-lg-0">
                  <div class="col-lg-6 text-center text-lg-start">
                    <h1 class="fs-2 fs-lg-2 text-black lh-base mt-3 mt-lg-0"> Find Your Office Space <span class="text-nowrap">or Working Space</span></h1>
                    <h1 class="fs-2 fs-lg-2 text-orange mb-2 mb-lg-x1 lh-base mt-lg-0">in few clicks</h1>
                  ...
                  <div class="col-lg-6 position-lg-relative">
                    <div class="position-lg-absolute z-1 text-center">
                      <!-- <img class="img-fluid float-end" src="{{ asset('assets/img/illustrations/Header.png') }}" alt="" /> -->
                      <!-- <img class="img-fluid chat-image" src="assets/img/Hero/Frame.webp" alt="" /> -->
